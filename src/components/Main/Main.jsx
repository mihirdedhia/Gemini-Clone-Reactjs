                    ...
                    ? <>
                        ...
                        <div className="cards">
                            <div className="card">
                                ...
                                <img src={assets.compass_icon} alt="icon image" />
                            </div>
                            <div className="card">
                                <p>Briefly summarize this concept: urban planning</p>
                                <img src={assets.bulb_icon} alt="icon image" />
                            </div>
                            <div className="card">
                                <p>Brainstorm team bonding activities for our work retreat</p>
                                <img src={assets.message_icon} alt="icon image" />
                            </div>
                            <div className="card">
                                <p>Improve the readability of the following code</p>
                                <img src={assets.code_icon} alt="icon image" />
                            </div>
                        </div>
                    </>
